...
function Wave() {
  ...
  return (
    ...
    <div className="our-partners-inner">
        <a target='_blank' rel="noreferrer" aria-label="Chads email" href="mailto:chadheisler5@gmail.com"><img className="gmail ic" src={gmail} alt="gmail" /></a>
        <a target='_blank' rel="noreferrer" aria-label="Chads github" href="https://github.com/Cheis415?tab=repositories"><img className="github ic" src={github} alt="github" /></a>
        <a target='_blank' rel="noreferrer" aria-label="chads Linkedin" href="https://www.linkedin.com/in/chad-heisler/"><img className="linkedin ic" src={linkedin} alt="linkedin" /></a>
        <a target='_blank' rel="noreferrer" aria-label="chads resume" href={resumeCopy}><img className="ic" src={resume} alt="resume" /></a>
    </div>
 </div>
 </div>
  )
